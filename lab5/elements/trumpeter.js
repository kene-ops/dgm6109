...
function drawTrumpeter(svgArea, horizontalPosition, verticalPosition, booleanValue) {
  ...
  trumpet Circle */
    ...
    if (choice === "play") {
        ...
        let trumpterNoteCircleUp = svgArea.append("circle")
            .attr("cx", horizontalPosition + 90)//horizontal, //original 190
            .attr("cy", verticalPosition - 255)//vertical, //original 45
            .attr("r", 5)//Radio
            .attr("fill", "none")
        ...
        let trumpterNoteCircleDown = svgArea.append("circle")
            .attr("cx", horizontalPosition + 105)//horizontal, //original 205
            .attr("cy", verticalPosition - 250)//vertical, //original 50
            .attr("r", 5)//Radio
            .attr("fill", "none")
            .attr("fill", "black");//this is the colour
        ...
        let trumpeterNoteLineLeft = svgArea.append("line")
            .attr("x1", horizontalPosition + 95)//this is the lengh of the note horizontal//original 195
            .attr("y1", verticalPosition - 255)//this is the lengh of the note vertical, //original 45
            .attr("x2", horizontalPosition + 95)//this is the position horizontal, //original 195
            .attr("y2", verticalPosition - 280)//this is the lenght of the object vertical, //original 20
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);

        /* this is the 
        musical note line right */
        let trumpeterNoteLineRight = svgArea.append("line")
            .attr("x1", horizontalPosition + 110)//this is the lengh of the Note horizontal, //original 210
            .attr("y1", verticalPosition - 250)//this is the lengh of the Note vertical, //original 50
            .attr("x2", horizontalPosition + 110)//this is the position horizontal, //original 210
            .attr("y2", verticalPosition - 275)//this is the lenght of the Note rect vertical, //original 25
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);

        /* this is the 
        musical note line rect */
        let trumpeterNoteLineRect = svgArea.append("line")
            .attr("x1", horizontalPosition + 95)//this is the lengh of the Note Rect horizontal, //original 195
            .attr("y1", verticalPosition - 280)//this is the lengh of the Note Rect vertical, //original 20
            .attr("x2", horizontalPosition + 110)//this is the position horizontal, //original 210
            .attr("y2", verticalPosition - 275)//this is the lenght of the Note Rect vertical, //original 25
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);
        ...
        let trumpterNoteCircleUp = svgArea.append("circle")
            .attr("cx", horizontalPosition + 90)//horizontal, //original 190
            .attr("cy", verticalPosition - 200)//vertical, //original 45
            .attr("r", 15)//Radio
            .attr("fill", "none")
            .attr("fill", "black");//this is the colour
        ...
        musical note circle down */
        let trumpterNoteCircleDown = svgArea.append("circle")
            .attr("cx", horizontalPosition + 130)//horizontal, //original 205
            .attr("cy", verticalPosition - 195)//vertical, //original 50
            .attr("r", 15)//Radio
            .attr("fill", "none")
            .attr("fill", "black");//this is the colour
        ...
        musical note line left */
        let trumpeterNoteLineLeft = svgArea.append("line")
            .attr("x1", horizontalPosition + 105)//this is the lengh of the note horizontal//original 195
            .attr("y1", verticalPosition - 260)//this is the lengh of the note vertical, //original 45
            .attr("x2", horizontalPosition + 105)//this is the position horizontal, //original 195
            .attr("y2", verticalPosition - 200)//this is the lenght of the object vertical, //original 20
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);
        ...
        musical note line right */
        let trumpeterNoteLineRight = svgArea.append("line")
            .attr("x1", horizontalPosition + 145)//this is the lengh of the Note horizontal, //original 210
            .attr("y1", verticalPosition - 250)//this is the lengh of the Note vertical, //original 50
            .attr("x2", horizontalPosition + 145)//this is the position horizontal, //original 210
            .attr("y2", verticalPosition - 195)//this is the lenght of the Note rect vertical, //original 25
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);
        ...
        musical note line rect */
        let trumpeterNoteLineRect = svgArea.append("line")
            .attr("x1", horizontalPosition + 105)//this is the lengh of the Note Rect horizontal, //original 195
            .attr("y1", verticalPosition - 260)//this is the lengh of the Note Rect vertical, //original 20
            .attr("x2", horizontalPosition + 145)//this is the position horizontal, //original 210
            .attr("y2", verticalPosition - 250)//this is the lenght of the Note Rect vertical, //original 25
            .attr("stroke", "black")//this is the colour
            .attr("stroke-width", 1);
        ...
        if (choice === "superPlay") {
            ...
            let trumpterNoteCircleUp = svgArea.append("circle")
                .attr("cx", horizontalPosition + 190)//horizontal, //original 190
                .attr("cy", verticalPosition - 120)//vertical, //original 45
                .attr("r", 5)//Radio
                .attr("fill", "none")
                .attr("fill", "black");//this is the colour
            ...
            musical note circle down */
            let trumpterNoteCircleDown = svgArea.append("circle")
                .attr("cx", horizontalPosition + 210)//horizontal, //original 205
                .attr("cy", verticalPosition - 110)//vertical, //original 50
                .attr("r", 5)//Radio
                .attr("fill", "none")
                .attr("fill", "black");//this is the colour
            ...
            musical note line left */
            let trumpeterNoteLineLeft = svgArea.append("line")
                .attr("x1", horizontalPosition + 195)//this is the lengh of the note horizontal//original 195
                .attr("y1", verticalPosition - 120)//this is the lengh of the note vertical, //original 45
                .attr("x2", horizontalPosition + 195)//this is the position horizontal, //original 195
                .attr("y2", verticalPosition - 145)//this is the lenght of the object vertical, //original 20
                .attr("stroke", "black")//this is the colour
                .attr("stroke-width", 1);
            ...
            musical note line right */
            let trumpeterNoteLineRight = svgArea.append("line")
                .attr("x1", horizontalPosition + 215)//this is the lengh of the Note horizontal, //original 210
                .attr("y1", verticalPosition - 110)//this is the lengh of the Note vertical, //original 50
                .attr("x2", horizontalPosition + 215)//this is the position horizontal, //original 210
                .attr("y2", verticalPosition - 140)//this is the lenght of the Note rect vertical, //original 25
                .attr("stroke", "black")//this is the colour
                .attr("stroke-width", 1);
            ...
            musical note line rect */
            let trumpeterNoteLineRect = svgArea.append("line")
                .attr("x1", horizontalPosition + 195)//this is the lengh of the Note Rect horizontal, //original 195
                .attr("y1", verticalPosition - 145)//this is the lengh of the Note Rect vertical, //original 20
                .attr("x2", horizontalPosition + 215)//this is the position horizontal, //original 210
                .attr("y2", verticalPosition - 140)//this is the lenght of the Note Rect vertical, //original 25
                .attr("stroke", "black")//this is the colour
                .attr("stroke-width", 1);
        ...
        if (choice === "superPlay") {
            ...
            let trumpterNoteCircleUp = svgArea.append("circle")
                .attr("cx", horizontalPosition + 120)//horizontal, //original 190
                .attr("cy", verticalPosition - 120)//vertical, //original 45
                .attr("r", 5)//Radio
                .attr("fill", "none")
                .attr("fill", "black");//this is the colour
            ...
            musical note line left */
            let trumpeterNoteLineLeft = svgArea.append("line")
                .attr("x1", horizontalPosition + 125)//this is the lengh of the note horizontal//original 195
                .attr("y1", verticalPosition - 120)//this is the lengh of the note vertical, //original 45
                .attr("x2", horizontalPosition + 125)//this is the position horizontal, //original 195
                .attr("y2", verticalPosition - 145)//this is the lenght of the object vertical, //original 20
                .attr("stroke", "black")//this is the colour
                .attr("stroke-width", 1);
            ...
            musical note line rect */
            let trumpeterNoteLineRect = svgArea.append("line")
                .attr("x1", horizontalPosition + 125)//this is the lengh of the Note Rect horizontal, //original 195
                .attr("y1", verticalPosition - 145)//this is the lengh of the Note Rect vertical, //original 20
                .attr("x2", horizontalPosition + 140)//this is the position horizontal, //original 210
                .attr("y2", verticalPosition - 140)//this is the lenght of the Note Rect vertical, //original 25
                .attr("stroke", "black")//this is the colour
                .attr("stroke-width", 1);
        }
